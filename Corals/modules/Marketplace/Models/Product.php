...
class Product extends BaseModel implements HasMedia
{
    use Indexable, Sluggable, PresentableTrait, LogsActivity,
        HasMediaTrait, GatewayStatusTrait, DownloadableModel, ReviewRateableTrait, Wishlistable, ModelHasComments;
    ...
    public function getSalesCount()
    {
        ...
        $order_items = OrderItem::where('type', 'Product')->whereIn('sku_code', $skus)->whereHas('order', function ($q) {
