@if($tracking)
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table ">
                    ...
                    <tr>
                        ...
                        <th>@lang('Marketplace::labels.order.desc')</th>
                        <th>@lang('Marketplace::labels.order.date')</th>
                        <th>@lang('Marketplace::labels.order.loc')</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
            ...
            <h3>@lang('Marketplace::labels.order.history')</h3>
            <div class="table-responsive">
...
@else
    <span class="">
               @lang('Marketplace::labels.order.no_track')
      </span>
