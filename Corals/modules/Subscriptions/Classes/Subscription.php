...
class Subscription
{
    ...
    public function createSubscription(Plan $plan, User $user = null, $subscription_data = null)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            self::generateCycle($subscription);
    ...
    static public function generateCycle($subscription)
    {
        \Corals\Modules\Subscriptions\Facades\UsageManager::generateCycle($subscription);
    }
     ...
     * @return bool
     */
    public function fetchPlan(Plan $plan, $gateway, $throwException = true)
    {
