...
//plan-usage
Breadcrumbs::register('plan_usage', function ($breadcrumbs) {
    $breadcrumbs->parent('dashboard');
    $breadcrumbs->push(trans('Subscriptions::module.plan_usage.title'), url(config('subscriptions.models.plan_usage.resource_url')));
});

//subscription-cycles
Breadcrumbs::register('subscription_cycles', function ($breadcrumbs) {
    $breadcrumbs->parent('dashboard');
    $breadcrumbs->push(trans('Subscriptions::module.subscription_cycle.title'), url(config('subscriptions.models.subscription_cycle.resource_url')));
});
