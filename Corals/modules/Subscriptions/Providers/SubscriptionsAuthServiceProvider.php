...
use Corals\Modules\Subscriptions\Policies\PlanUsagePolicy;
use Corals\Modules\Subscriptions\Policies\ProductPolicy;
use Corals\Modules\Subscriptions\Policies\SubscriptionCyclePolicy;
...
class SubscriptionsAuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        PlanUsage::class => PlanUsagePolicy::class,
        SubscriptionCycle::class => SubscriptionCyclePolicy::class,
    ];
