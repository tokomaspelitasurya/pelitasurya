                        ...
                        <div class="user-cover"
                            ...
                            @if(\Settings::get('marketplace_checkout_points_redeem_enable',true) )
                                ...
                                <div class="info-label" data-toggle="tooltip" title=""
                                     data-original-title="@lang('corals-marketplace-master::labels.partial.points_spend',['points'=>$points])">
                                    <i
                                            class="icon-medal"></i><a
                                            href="{{url('referral/my-referrals')}}">@lang('corals-marketplace-master::labels.partial.points_balance',['points'=>$points])</a>
                                </div>
                            @endif
                        </div>
                        <div class="user-info">
